                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" id="createCustomerForm"
                                        action="{{ route('admin.works.update' , $project->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="name_ar">{{ __('models.name_ar') }}</label>
                                                    <input type="text" id="name_ar" class="form-control" name="name_ar"
                                                        value="{{ old('name_ar' , $project->name_ar) }}" required/>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="name_en">{{ __('models.name_en') }}</label>
                                                    <input type="text" id="name_en" class="form-control" name="name_en"
                                                        value="{{ old('name_en' , $project->name_en) }}" required/>
                                            ...
                                            <div class="form-group prev">
                                                <img src="{{ asset('storage/'.$project->img) }}" style="width: 100px" class="img-thumbnail preview-formFile" alt="">
                                            </div>
