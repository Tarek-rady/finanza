...
@section('title' , __('models.edit_team')  )
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.edit_team') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ __('models.edit_team') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" id="createCustomerForm"
                                        action="{{ route('admin.teams.update' , $clint->id) }}" method="POST"
                                               ...
                                               <div class="col-md-6 col-12 mb-3">
                                                <label for="facebook">{{ __('models.facebook') }}</label>
                                                    <input type="text" id="facebook" class="form-control" name="facebook"
                                                        value="{{ old('facebook' , $clint->facebook) }}" required/>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="instagram">{{ __('models.instagram') }}</label>
                                                    <input type="text" id="instagram" class="form-control" name="instagram"
                                                        value="{{ old('instagram' , $clint->instagram) }}" required/>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <label for="twitter">{{ __('models.twitter') }}</label>
                                                    <input type="text" id="twitter" class="form-control" name="twitter"
                                                        value="{{ old('twitter' , $clint->twitter) }}" required/>
