...
@section('title', __('models.feautures'))
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">{{ __('models.feautures') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="form-group breadcrumb-right">
                        <div class="dropdown">
                            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a feauture">
                                    <a href="{{ route('admin.feautures.create') }}" class="btn btn-primary">
                                        <span><i class="fa fa-plus"></i></span>
                                        <span> {{ __('models.add_feauture') }} </span>
                                    </a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Second group">
                                                            <a href="{{ route('admin.feautures.edit', $category->id) }}"
                                                                class="btn btn-sm btn-primary"><i
                                                                    class="fa-solid fa-pen-to-square"></i>
                                                            </a>

                                                            <a href="{{ route('admin.feautures.destroy', $category->id) }}"
                                                                data-id="{{ $category->id }}"
