                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="top" title="" class="avatar pull-up my-0" data-original-title="{{ $category->name }}">
                                                        <img src="{{ asset('storage/'. $category->img) }}" alt="Avatar" height="50" width="50" />
                                                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    @include('dashboard.backend.categories.seemore')
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Second group">
                                                            <a href="{{ route('admin.works.edit', $category->id) }}"
                                                                class="btn btn-sm btn-primary"><i
                                                                    class="fa-solid fa-pen-to-square"></i>
                                                            </a>

                                                            <a href="{{ route('admin.works.destroy', $category->id) }}"
                                                                data-id="{{ $category->id }}"
